          ...
          {state === 'loading' ? (
            ...
            <div className={styles.quoteCard} key={active}>
              ...
              <div className={styles.client}>
                <div className={styles.clientAvatar} aria-hidden="true">{t.company.charAt(0)}</div>
                <div>
              ...
              <div className={styles.stars} aria-label={`${rating} star rating`}>
                {Array.from({ length: 5 }).map((_, i) => (
                  <svg key={i} viewBox="0 0 24 24" fill={i < rating ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth={i < rating ? 0 : 1.5} style={{ opacity: i < rating ? 1 : 0.3 }} aria-hidden="true">
